...
//    }   
    ...
    @RequestMapping(value = { "index", ""}, method = GET)    
    public String index(@RequestParam(required = false) String errormessage,String successmessage,Model model) {	
    	
    		return "index";    	
    }

    @RequestMapping(value = { "myView"}, method = GET)
    public String myView(@RequestParam(required = false) String errormessage,Model model) {	    		
    	return "myView";
    }   
